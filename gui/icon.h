...
enum {
    ...
    ICON_WIFI, ICON_LOCK, ICON_WIFI_OFF, ICON_REFRESH,
    ICON_WIFI_4, ICON_WIFI_3, ICON_WIFI_2, ICON_WIFI_1, ICON_WIFI_0,
    ICON_LAN, ICON_PUBLIC, ICON_DOWNLOAD, ICON_CHECK,
    ICON_COUNT
};
