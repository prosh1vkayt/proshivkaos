...
def main():
    ...
    # Просим журнал с самого начала. Без этого мы увидим только то, что
    # система напечатает ПОСЛЕ подключения, — а самое ценное всегда в
    # первых строках, задолго до того, как хост нас заметил.
    send(dev, "d")
